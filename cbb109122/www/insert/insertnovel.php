...
$link = mysqli_connect("localhost","cbb109122","God19520","cbb109122_fiction") or die("無法開啟MySQL資料庫連接!<br/>");
   mysqli_query($link, 'SET NAMES utf8');
    $sql = "INSERT INTO  novel (novelid,chapter,chaptername,content) VALUE ('$novelid','$chapter','$chaptername','$content') ";
...
?>
<form action="insertnovel.php" method="post" >
    <br>
    <label for="novelid">小說編號:</label>
    <input type="users" name="novelid" id="novelid" required autofocus/>
